...
function updateChangelogVisibility() {
    ...
    const isAdmin = name === 'everseekn' || name === 'destroy' || localStorage.getItem('adminPrivilege') === 'true';
...
function hasUnlimitedNameChange(nameToCheck = null) {
    ...
    if (name === 'shoso' || name === '8887888888888888' || name === 'wethermoon' || name === 'parry' || name === 'destroy') {
