...
const LEADERBOARD_TITLES = {
    cps:      { 1: 'CLICK GOD',        2: 'SPEED DEMON',      3: 'PARMAK FIRTINASI',  4: 'CLICK PRO',         5: 'FAST HANDS' },
    reaction: { 1: 'LIGHTNING',        2: 'REFLEX BEAST',     3: 'NEURO LINK',        4: 'ŞAHİN GÖZ',         5: 'TETİKTE' },
    accuracy: { 1: 'HEADSHOT',         2: 'SNIPER ELITE',     3: 'KESKİN GÖZ',        4: 'AIM PRO',           5: 'HEDEF AVCISI' },
    color:    { 1: 'PRİZMA LORD',      2: 'COLOR GURU',       3: 'SPECTRUM',          4: 'KROMA',             5: 'PALETÇİ' },
    sequence: { 1: 'MEMORY GOD',       2: 'ZİHİN MİMARI',     3: 'BRAIN HACK',        4: 'RECALL PRO',        5: 'HATIRLAYAN' },
    luck:     { 1: 'LUCKY GOD',        2: 'FORTUNA',          3: 'TALİH KUŞU',        4: 'RISK TAKER',        5: 'SOĞUKKANLI' },
};
